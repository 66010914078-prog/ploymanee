...
<div class="container mt-5 mb-5">
    ...
    <form method="post" action="" class="p-4 p-md-5 border rounded-3 shadow-lg" style="background-color: var(--pastel-mint-green); border-color: #B2D9D2 !important;">
...
if (isset($_POST['SubmitApplication'])) {
    ...
    (a_position, a_salary, a_prefix, a_firstname, a_lastname, a_dob, a_contact,
     a_edu_level, a_major, a_skills, a_experience, a_others)
    VALUES ('{$position}', '{$prefix}', '{$firstname}', '{$lastname}', '{$dob}', '{$contact}', '{$edu_level}', '{$major}', '{$skills}', '{$experience}', '{$others}')";

  mysqli_query($conn,$sql) or die ("insret ไม่ได้");
	...
	mysqli_connect("localhost","root","4078db");
}
?>
